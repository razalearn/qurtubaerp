        ...
        @if($errors->any())
            <div class="bg-red-100 border-l-4 border-red-500 p-4 mt-4">
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <div class="text-sm leading-5 text-red-700 mb-3">
                            <strong>If you are getting error with database connection, please check this first:</strong>
                        </div>
                        <div class="text-sm leading-5 text-red-700" style="margin-left: 16px;">
                            <ul class="list-disc list-inside text-sm leading-5 text-red-700">
                                <li>1) Check your database host, port, name, username and password.</li>
                                <li>2) Check if you install <strong>nd_pdo_mysql</strong> extension in your server.</li>
                            </ul>
                        </div>
                    </div>
                </div>
